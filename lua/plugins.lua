...
return require("packer").startup(function()
    ...
    use {
        ...
        after = { "cmp", "snip", "cmp-lsp", "cmp-snip" },
        config = function() LSPConfigFn() end,
        as = "lspconfig",
    }
    ...
    use { 'jackguo380/vim-lsp-cxx-highlight', ft = { "c", "cpp" }, after = { "lspconfig" } }
    ...
    use { 'idanarye/vim-dutyl', ft = "d" }


    use { '~/src/todotxt.nvim/', requires = { 'MunifTanjim/nui.nvim' } }
end)
