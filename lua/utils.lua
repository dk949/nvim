...
---@param opts? {settings?:table,init_options?:table,filetypes?:table|string,root_dir?:table,cmd?:table,install?:boolean} optional options for the lsp
---@return table?
    ...
    return {
        server = M.lspSetupCreate(servername,
            function(capabilities, on_attach)
                ...
                if opts.cmd then setup.cmd = opts.cmd end
